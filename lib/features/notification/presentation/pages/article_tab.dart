                  ...
                  Expanded(
                    child: NotificationListener<ScrollNotification>(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: cubit.articels.length ?? 0,
                          ...
                          return InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                ...
                                arguments: cubit.articels[index].id,
                              );
                            },
                            child: Card(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        CachedNetworkImage(
                                          imageUrl:
                                              '${Constant.storage}${cubit.articels[index].thumbnail}' ??
                                                  '',
                                          imageBuilder:
                                    ...
                                    Text(
                                      cubit.articels[index].shortDescription ??
                                          '',
                                      style: TextStyle(
                                    ...
                                    Text(
                                      cubit.formatTime(cubit.articels.isNotEmpty
                                              ? cubit.articels[index]
                                                      .createdAt ??
                                                  DateTime.now()
                                              : DateTime.now()) ??
                                          '',
